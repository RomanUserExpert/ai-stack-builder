...
and they are navigated as such. A tab strip at the top of both lists **all twelve lessons** —
research and benchmark, personas and JTBD, information architecture, prototyping, tone of voice,
concept, UI assembly, design tokens, design system, responsive, animation, handoff — with the current
one marked and the ten unbuilt ones marked *soon*. **Lesson 01 carries research stages 1–5; lesson 02
carries stages 6–7.** Each page has the same shape as the course's own reference page: a skip link, a
meta line saying which lesson of twelve and when it was last re-verified, a left rail titled *in this
lesson*, an **Overview** of what we saw and what we decided, the stage sections, and the evidence.
**The lesson list is the course's, not ours** — do not substitute the project's build phases for it.
