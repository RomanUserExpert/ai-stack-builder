...
**The two pages are the project's first two phases, and they are navigated as such.** A tab strip at
the top of both lists the six phases of §1's agreed order of work — **01 Research and benchmark**
(stages 1–5), **02 People and jobs** (stages 6–7), then design system, mockups, static frontend and
logic, marked *soon*. Each page carries the same shape: an **Overview** of what we saw and what we
decided, the stage sections, the close, and the evidence. **Stages 6 and 7 live on page 02 only** —
they were briefly on page 01 and were moved when the two-phase split was made.
