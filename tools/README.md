...
[`../research.html`](../research.html) is a **generated** file: one self-contained page with all 34
...
python tools/make_standalone.py   # wrap in a full HTML document   -> research.html
```
...
its own document wrapper); `research.html` is the standalone file. They are the same page.
