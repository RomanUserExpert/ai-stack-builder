...
5. ~~**The half-day that keeps not being spent.**~~ **Spent 2026-09-10** — [`re-research-3.md`](re-research-3.md) Q-F; this line is left as written because this document is a dated record. NK-13 / Q-A. Every round of research makes it more load-bearing and none of them can touch it. **Round 3 finally points an instrument at it** — [`re-research-3.md`](re-research-3.md) **Q-F**, written 2026-09-09 when the interviews became unavailable and the only questions left were the ones that need no person.
